...
Code, Experimente und Auswertungen zur Masterarbeit zur Optimierung der Vektorsuche mit Embeddings und
Gewichtungsmethoden.
...
Wenn alle Embeddings vollständig neu berechnet werden sollen (ACHTUNG: je nach Hardware mehrere Tage Laufzeit), sind
dafür die folgenden vier Skripte vorgesehen.  
...
"Vergleich und Optimierung von Ansätzen zur Verbesserung der Vektorsuche in großen Datensätzen – Eine Analyse von
Embedding- und Gewichtungsmethoden"*. GitHub-Repository, verfügbar
unter: https://github.com/Fucksilein/masterarbeit-vektorsuche
